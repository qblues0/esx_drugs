...
Config.CircleZones = {
	...
	--Heroin
	HeroinField = {coords = vector3(-1811.94, 1126.04, 217.61), name = _U('blip_heroinfield'), color = 25, sprite = 496, radius = 20},
	HeroinProcessing = {coords = vector3(534.49, -781.78, 16.01), name = _U('blip_heroinprocessing'), color = 25, sprite = 496, radius = 100.0},

	--DrugDealer
	DrugDealer = {coords = vector3(-1173.02, -1571.98, 4.66), name = _U('blip_drugdealer'), color = 6, sprite = 378, radius = 25.0},
	
	--License
	LicenseShop = {coords = vector3(608.8, -467.51, 25.54), name = _U('blip_lsdprocessing'),color = 25, sprite = 496, radius = 20.0},
