RegisterServerEvent('ddx_drugs:buyLisense2')
AddEventHandler('ddx_drugs:buyLisense2', function(itemName)
...
ESX.RegisterServerCallback('ddx_drugs:CheckJob', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
