...
RegisterServerEvent('ddx_drugs:pickedUpCannabis')
AddEventHandler('ddx_drugs:pickedUpCannabis', function()
...
RegisterServerEvent('ddx_drugs:processCannabis')
AddEventHandler('ddx_drugs:processCannabis', function()
	if not playersProcessingCannabis[source] then
		...
		print(('ddx_drugs: %s attempted to exploit weed processing!'):format(GetPlayerIdentifiers(source)[1]))
	end
end)
